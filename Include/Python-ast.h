...
enum _stmt_kind {FunctionDef_kind=1, AsyncFunctionDef_kind=2, ClassDef_kind=3,
                  ...
                  AsyncFor_kind=10, Kartok_kind=11, While_kind=12, If_kind=13, With_kind=14,
                  AsyncWith_kind=15, Raise_kind=16, Try_kind=17,
...
stmt_ty _Py_For(expr_ty target, expr_ty iter, asdl_seq * body, asdl_seq *
                ...
                end_lineno, int end_col_offset, PyArena *arena);
#define Kartok(a0, a1, a2, a3, a4, a5, a6) _Py_Kartok(a0, a1, a2, a3, a4, a5, a6)
stmt_ty _Py_Kartok(expr_ty target, asdl_seq * body, int lineno, int col_offset, int
                end_lineno, int end_col_offset, PyArena *arena);
