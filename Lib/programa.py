...
class TNavigator(object):
    ...
    def forward(self, nuotolis):
        """Perstumia pieštuką nurodytu nuotoliu tiesiai pirmyn.

        Aliases: forward | fd | pr | priekin | pirmyn

        Argument:
        nuotolis -- sveikas skaičius arba skaičius su kableliu.

        Perstumia pieštuką nurodytu nuotoliu ta kryptimi, į kurią pieštukas žiūri.
    ...
    def back(self, nuotolis):
        """Patraukia pieštuką atgal.

        Aliases: back | backward | bk | atgal | atbulyn

        Argument:
        nuotolis -- skaičius (sveikas arba su kableliu)

        Patraukia pieštuką atgal (t.y. į priešingą pusę nei pieštukas žiūri).
    ...
    def right(self, laipsniai):
        """pasuka pieštuką dešinėn nurodytu kampu

        Aliases: right | rt | dešinėn | desinen 

        Argument:
        laipsniai -- skaičius (sveikas arba su kableliu)
        ...
        337.0
        """
        self._rotate(-laipsniai)

    def left(self, laipsniai):
        """Pasuka pieštuką kairėn nurodytu kampu.

        Aliases: left | lt | kairėn | kairen
    ...
    def home(self):
        """Atstumia pieštuką atgal į pradinę poziciją (koordinatės 0,0)
...
## three dummy methods to be implemented by child class:
    ...
    pasislėpk = hideturtle
    slėpkis = hideturtle

    rodykis = showturtle
    pasirodyk = showturtle
...
def paspaudus(komandosKodas, funkcija):
    Screen().cv.bind_all(komandosKodas, funkcija)
